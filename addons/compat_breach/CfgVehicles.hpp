class CfgVehicles {
    ...
    class tsp_breach_dip_place: ACE_Explosives_Place_SLAM { XEH_ENABLED; }; // "M4A1 SLAM" @Breach_Rewrite
    class tsp_breach_dip_auto_place: tsp_breach_dip_place { XEH_ENABLED; }; // "M4A1 SLAM" @Breach_Rewrite
};
